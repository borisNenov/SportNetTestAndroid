...
namespace com.refractored.monodroidtoolkit
{
	...
	{
		private readonly TouchImageView m_ScaleImageView;
		public ScaleImageViewGestureDetector(TouchImageView imageView)
		{
	...
	public class TouchImageView : ImageView, View.IOnTouchListener
	{
