...
namespace SportNet
{
	[Activity (Label = "NewsGroupActivity", ScreenOrientation = ScreenOrientation.Portrait)]			
	public class NewsGroupActivity : ActivityGroup
	{
		...
		protected override void OnCreate(Bundle bundle)
		{
			...
			StartChildActivity("news", new Intent(this, typeof(UserCategoryActivity)));
			//StartChildActivity("news", new Intent(this, typeof(NewsActivity)));
		}
